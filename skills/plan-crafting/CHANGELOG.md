...
- Added a TDD-aware handoff: behavior-changing tasks state acceptance evidence and invoke
  `tdd` for the test-first micro-cycle instead of using test-after task wording.
