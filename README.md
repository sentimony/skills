...
| [tdd](skills/tdd/SKILL.md) | 1.0.1 | v1.32.0 | Drive behavior changes through valid RED, sufficient GREEN, and evidence-backed refactoring. |
| [debugging](skills/debugging/SKILL.md) | 1.0.4 | v1.32.0 | Investigate bugs and unexpected technical behavior with a root-cause-first evidence workflow. |
