...
| [frontend-crafting](skills/frontend-crafting/SKILL.md) | 1.0.0 | v1.17.0 | Create, redesign, review, and polish user interfaces with subject-driven design decisions and a verifiable quality gate. |
