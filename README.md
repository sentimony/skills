...
| [typescript](skills/typescript/SKILL.md) | 1.3.3 | v1.12.1 | Configure tsconfig, diagnose compiler behavior, and audit or migrate TypeScript projects. |
...
| [frontend-craft](skills/frontend-craft/SKILL.md) | 1.0.0 | v1.17.0 | Create, redesign, review, and polish user interfaces with subject-driven design decisions and a verifiable quality gate. |
...
npx skills add sentimony/skills -s frontend-craft -a codex claude-code -y
```
