...
| [typescript](skills/typescript/SKILL.md) | 1.0.0 | Configure tsconfig, resolve compiler errors, debug slow type-checking, fix module resolution, migrate JS to TS. Script-assisted TypeScript skill. |
