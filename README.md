...
| --- | --- | --- | --- |
| [web-debug](skills/web-debug/SKILL.md) | 1.1.2 | v1.3.1 | Debug local web apps via Playwright. Script-assisted browser debugging skill. |
...
| [typescript](skills/typescript/SKILL.md) | 1.1.1 | v1.3.1 | Configure tsconfig, resolve compiler errors, debug slow type-checking, fix module resolution, and migrate JavaScript or compiler major versions. Script-assisted TypeScript skill. |
| [echarts](skills/echarts/SKILL.md) | 1.0.3 | v1.3.1 | Build, audit, style, debug, and optimize Apache ECharts visualizations in vanilla JS, React, or Vue. |
