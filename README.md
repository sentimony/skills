...
| [typescript](skills/typescript/SKILL.md) | 1.2.0 | v1.4.0 | Configure tsconfig, resolve compiler errors, debug slow type-checking, fix module resolution, and migrate JavaScript or compiler major versions. Script-assisted TypeScript skill. |
